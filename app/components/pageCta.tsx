        ...
        >
            ...
            <div className="relative z-10 mx-auto max-w-2xl px-6">
                ...
                <button
                    ...
                    className="mt-10 inline-flex items-center gap-2 rounded-lg border border-white/30 bg-transparent px-9 py-4 text-sm font-semibold text-white shadow-xl backdrop-blur-sm transition hover:bg-white/10 hover:shadow-2xl"
                >
