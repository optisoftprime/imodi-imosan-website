      ...
      <div className="relative mx-auto grid max-w-[1200px] grid-cols-1 items-center gap-16 lg:grid-cols-2">
        ...
        <div className="relative" style={{ height: 440 }}>
          ...
          <div className="absolute inset-0">
            ...
            <Image src={rect26} alt="Consumer loan" fill className="object-contain object-center" />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="mt-5 space-y-4 text-[15px] leading-[1.85] text-gray-500">
            <p>
              Handle unexpected expenses and important moments with confidence, knowing you have the support
              you need. Whether it's urgent needs or planned expenses, you can move forward without stress
              or delay.
            </p>
            <p>
              With flexible financial solutions and a simple process, you can stay in control, take care of
              what matters, and keep life moving smoothly.
            </p>
          </div>
  ...
  return (
    <section className="bg-white px-8 pb-24 pt-4">
      <div className="mx-auto max-w-[1200px]">
        ...
        <div className="relative flex items-end justify-center" style={{ height: 360 }}>
          ...
          >
            ...
            <Image src={rect26} alt="Couple with tablet" fill className="object-cover" />
          </div>
          ...
          <div
            ...
            style={{ width: 380, height: 300, marginBottom: 60, marginLeft: -16, zIndex: 2 }}
          >
            {/* swap with actual couple photo 2 */}
            <Image src={rect27} alt="Couple relaxing" fill className="object-cover" />
          </div>
        </div>
      </div>
    </section>
